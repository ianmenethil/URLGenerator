...
This is a simple HTML tool designed to generate pre-filled setup URLs for the ZenPay payment system (`https://pay.zenpay.com.au/setup/{merchantCode}`).
...
1.  Open the [`public/index.html`](public/index.html) file in your web browser.
...
-   The entire tool is contained within a single HTML file ([`public/index.html`](public/index.html)).
